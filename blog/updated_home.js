  ...
  return (
    <div className="container-sm" style={{maxWidth: 1000}}>
      <div className="frame">
        ...
        <div className="container-sm" style={{justifyContent: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
          <Link to='cnn' className="link-offset-3 module-link" style={{marginBottom: 15}}>Image Classification with CNNs</Link>
