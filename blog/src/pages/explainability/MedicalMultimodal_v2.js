  ...
  return (
    <div style={{
      ...
      <article style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        {/* Introduction - NEW: Multimodal Revolution */}
        <section style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '18px', lineHeight: '1.8', marginBottom: '24px' }}>
            Modern AI has entered a multimodal era. Models like CLIP bridge vision and language, GPT-4V integrates 
            text and images seamlessly, and medical systems like MedCLIP combine radiology with clinical notes to 
            achieve unprecedented diagnostic accuracy. These systems are being deployed in high-stakes domains—from 
            medical diagnosis to autonomous systems—where understanding what they learn is crucial.
          </p>

          <p style={{ fontSize: '18px', lineHeight: '1.8', marginBottom: '24px' }}>
            But here's the fundamental question: <strong>When different multimodal models process the same data, 
            do they learn similar representations?</strong> And how can we even answer that question?
          </p>
          ...
          <div style={{
            ...
            <p style={{
              ...
              If models trained on different modalities or tasks converge on similar internal features, what does 
              that say about their shared representational space? Can explainability metrics help us quantify this 
              convergence? This tutorial explores these questions through the lens of medical AI.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{
              ...
              <strong>A motivating example:</strong> A radiologist examines a chest X-ray showing possible COVID-19 
              pneumonia. The AI confidently predicts "98% COVID-19 positive." But when researchers investigated, they 
              discovered the model wasn't looking at lung pathology at all—it was reading the hospital metadata printed 
              in the corner of the image.
            </p>
          </div>

          <p style={{ fontSize: '18px', lineHeight: '1.8', marginBottom: '24px' }}>
            This isn't just an embarrassing failure. It reveals why we need to understand what representations 
            models learn—and whether different models learn similar things. When we deploy multimodal AI in medicine, 
            we're not just asking "does it work?" but "what has it learned?" and "is that learning consistent across 
            different architectures?"
          </p>

          <p style={{ fontSize: '18px', lineHeight: '1.8', marginBottom: '24px' }}>
            This blog post is an interactive tutorial that explores how explainability techniques serve dual purposes: 
            they make individual models trustworthy, AND they provide tools for studying whether different models 
            converge on similar representations. Through examples from medical AI, we'll see how attention visualization, 
            attribution methods, and other techniques illuminate both individual model behavior and cross-model similarity.
          </p>
        </section>
